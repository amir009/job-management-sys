...
<%! int employerId,vacancies,applicants,jobId,prevpg=0,pageno=0,cnt=0,exp=0,perpage=5,prv=0; %>
            ...
            $(document).ready(function () {
             ...
             function searchit(){
                ...
                if(exp!==0){
                 ...
                 window.location="myPosts.jsp"+urlprm;
             }    
            </script>
        <div class="wrapper" >
        <h1 class="text-center " style="color:#719f37">My Job Posts</h1>
	...
	<img  src="images/j4.jpg" width="300" height="300" />
            ...
            <div class=" col-md-9 col-lg-9 ">
                ...
                <div id="custom-search-input">
                    ...
                    <div class="col-sm-2">
                        <select id="secret_ques" name="" class="form-control">
            ...
            <table class="table table-striped table-bordered" style="margin-top: 50px">
                ...
                <th class="col-sm-1">
                    <strong class="Theader">Applicants </strong> 
                </th> 
                <th class="col-sm-3">
        ...
        <%
            ...
            String query="SELECT j. * , e . * , COUNT( t.empid ) as applicants FROM jobs j LEFT JOIN employer e ON j.employerId = e.uid LEFT JOIN test_results t ON j.jobid = t.jobid where Status='ACTIVE' ";
            String orderby="GROUP BY jobid  order by j.jobid desc limit "+start+","+perpage;
             cnt=0;
        ...
        %>
          <tr class=" jtable" >
                <td class="col-sm-3 pointer">
                    <a href="jobdetailsPro.jsp?jobid=<%=jobid%>"> <span class="row" style="color:#990033;font-size: 15px;font-weight:bold "><%=job_title%></span>   
