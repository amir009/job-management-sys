...
<%! int employerId,vacancies,jobId,prevpg=0,pageno=0,cnt=0,exp=0,perpage=5,prv=0; %>
...
<%
    ...
    if(session.getAttribute("username")!=null && session.getAttribute("userId") !=null  ){
        ...
        String site = new String(baseURL+"jobpost.jsp");
            ...
            if (e.which == 13) {
             ...
             function searchit(){
                ...
                if(exp!==0){
                 ...
                 window.location="jobsearch.jsp"+urlprm;
             }   
                
            </script>
        <div class="wrapper" >
        <h1 class="text-center " style="color:#719f37">Job Search</h1>
	...
	<img  src="images/j4.jpg" width="300" height="300" />
        ...
        <%
            ...
            String query="select * from jobs j,employer e where e.uid =j.employerId and Status='ACTIVE' ";
...
%>
        ...
        <div class="pull-left"><a href="jobsearch.jsp?pageno=<%=prv+pageUrlparams%>"><button type="button" class="btn btn-primary btn-block ">Back</button></a></div>
        <%}%>
        <% if(cnt>=perpage){ %>

<div class="pull-right "><a href="jobsearch.jsp?pageno=<%=pageno+pageUrlparams%>"><button type="button" class="btn btn-primary btn-block ">Next</button></a></div>
<%}%>
        </div>    
        </div>
        </div>
