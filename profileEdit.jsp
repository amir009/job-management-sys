...
<%! ResultSet rs=null; %>
<%! String username,password,secret_ques,secret_ans,first_name,last_name,dob,gender,email,cellno,hobbies=""; %>
<%
	...
	<img alt="User Pic" src="images/profile-pic.jpg" width="200px" height="200px" class="img-circle">
         ...
         <%=username %>
            ...
            <div class=" col-md-9 col-lg-9 ">
                <ul class="nav nav-tabs">
                  ...
                  <form class="form-horizontal" id="profilefrm" role="form" method="post" action="userUpdate.jsp" style="padding: 30px;">
		...
		<div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-3">
                        <input type="date" id="dob" name="dob" value="<%=dob%>" class="form-control validate[required,custom[date1]]">
                    </div>
                </div>
                ...
                <div class="form-group">
				 ...
				 <div class="form-group">
                    ...
                    <div class="col-sm-3">
                        <input type="text" id="hobbies" name="hobbies" placeholder="Hobbies" value="<%=hobbies%>" class="form-control ">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-2">
                        <a href="profile.jsp"><button type="button" class="btn btn-primary btn-block">Cancel</button></a>
                    </div>
                </div>
            </form> 
        </div>
