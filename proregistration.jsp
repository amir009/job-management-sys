   ...
   text-align: center;
	...
	if (field.val() !== $("#password").val()) {
     return "Passwords Don't Match";
        ...
        <div class="container">
            <form class="form-horizontal" id="regform" role="form" method="post" action="proregisterSubmit.jsp">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" id="designation" name="designation" class="form-control validate[required]">
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        <div class="row">
                            ...
                            <div class="col-sm-4">
                                <label class="radio-inline">
                                    <input type="radio" id="maleRadio" class="validate[required]" name="gender" value="Male">Male
                                </label>
                            </div>
